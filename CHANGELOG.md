...
- Revise enum exports as not playing nicely with bundlers

## [1.2.2] - 2025-12-12

### Updated

- Update package deployment scripts

## [1.2.1] - 2025-12-12

### Added

- Add support for `CommonJS` and `ESM` module formats

### Updated

- Fix type namespacing issue
- Clean up duplicated type definitions
